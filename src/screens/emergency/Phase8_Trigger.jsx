              ...
              <>
                ...
                <div className="score-slider-wrap">
                  <ScoreSlider
                    ...
                    showValue={false}
                    labels={[
                      { text: '10 = שורף', className: 'activation-label-burning' },
                      { text: '5 = יש משהו', className: 'activation-label-mid' },
                      { text: '1 = רגוע', className: 'activation-label-calm' },
                    ]}
                    ariaLabel="כמה אתה מופעל עכשיו, מ-1 עד 10"
                  />
                </div>
