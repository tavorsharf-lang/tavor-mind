...
export const SOMATIC_EXERCISES = [
  ...
  },
  {
    id: 'vagal_humming',
    title: 'רטט קולי',
    subtitle: 'הצליל מרטיט את עצב הוואגוס מבפנים',
    why: 'נשיפה מאורכת + ויברציה של מיתרי הקול → מפעילה את הוואגוס הוונטרלי (השכבה החברתית של הפוליווגאל)',
    forActivation: ['hypo', 'mid'],
    short: { durationSec: 60, label: 'קצר · דקה' },
    long:  { durationSec: 90, label: 'מומלץ · 90 שניות' },
    instructions: [
      'הנח יד אחת על הגרון, יד שנייה על החזה',
      'שאף עמוק דרך האף',
      'בנשיפה - הפק קול "מממם" נמוך, ארוך ככל שנוח',
      'שים לב לוויברציה מתחת לידיים',
    ],
    animation: 'vagal',
    supportsSilent: true,
    silentNote: 'אם אתה לא יכול להפיק קול עכשיו (משרד, תחבורה, אנשים בסביבה) - המהם בפה סגור, נמוך ושקט. הוויברציה עדיין נוצרת.',
  },
  {
    id: 'body_scan',
