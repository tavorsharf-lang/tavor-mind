...
const TOOLS = [
  { id: 'schemas',    icon: <SchemasIcon />,    tone: 'self',   title: 'פרופיל הסכמות',   subtitle: '4 הדפוסים שהכי משפיעים עליך',     route: '/toolbox/schemas' },
  { id: 'attachment', icon: <AttachmentIcon />, tone: 'self',   title: 'פרופיל ההיקשרות', subtitle: '"החזק החרד" — איך אתה בקשרים',     route: '/toolbox/attachment' },
  { id: 'modes',      icon: <ModesIcon />,      tone: 'self',   title: '5 הקולות שלך',     subtitle: 'הילד שבמרכז, המגנים סביבו, המבוגר הבריא רואה הכל', route: '/toolbox/modes' },
