...
- `src/config/sessionTypes/` — קונפיגים פר-סשן (`anticipatoryAnxiety.js`, `parentalAnger.js`, `relationshipConflict.js`, `rumination.js`). כל סשן עומד בפני עצמו. helpers משותפים ב-`_promptHelpers.js`.
